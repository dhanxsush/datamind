...
Node.js and npm (or yarn): For managing frontend packages and running scripts. (Download from https://nodejs.org/)
Python (3.8+ recommended) and pip: For backend development. (Download from https://www.python.org/)
Git: For cloning the repository. (Download from https://git-scm.com/)
Supabase Account: You will need a Supabase project for database and backend services. (Create one at https://supabase.com/)
Configuration
...
cd datamind_final
Backend Setup (project_final/backend):
...
Frontend Setup (project_final/frontend):
...
Code Citations
This project aims to adhere to proper citation practices for any external code snippets or libraries that have specific attribution requirements beyond their standard licenses. Please refer to the project_final/# Code Citations.md file for a list of any such citations.
